...
\begin{multicols}{3}
  ...
  \begin{tabular}{L{0.55\linewidth} L{0.45\linewidth}}
    ...
    \tt \textbf{var.is\_a? Object}               & check if \itt{var} is a or inherits from \itt{Object} \\
    \tt \textbf{var.instance\_of? Object}        & check if \tt{var} is an \itt{Object}                  \\
    \tt \textbf{var.responds\_to? :method}       & check if \tt{var} has method \tt{method}              \\
  \end{tabular}

  \section{Modules}
  \begin{tabular}{L{0.55\linewidth} L{0.45\linewidth}}
    \tt \textbf{class} \itt{MyModule} & define module                            \\
    ...
    \tt ~~def\_delegators: @name, :size, :empty & create delegate methods for \itt{@name} \\
  \end{tabular}
  ...
  \begin{tabular}{L{0.55\linewidth} L{0.45\linewidth}}
    ...
    \tt ~~\itt{statement} \\
    \tt end \\
    \tt \textbf{class\_eval} ``\itt{statement}'' & evaluates string with a class \\
  \end{tabular}
